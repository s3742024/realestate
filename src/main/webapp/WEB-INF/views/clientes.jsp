...
<title>RealEstate | Clientes Cadastrados</title>
...
<body class="hold-transition skin-blue sidebar-mini">
	<script type="text/javascript">
		function removeCliente(id){
			$("#mensagem").load('<c:url value="/excluircliente"/>' + '?clienteId=' + id).removeClass("hidden");
			alerta();
			$("#cliente" + id).remove();
		}
		function alerta(){
			...
			<section class="content">
				...
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Relatório de Clientes Cadastrados</h3>
									...
									<div class="box-body table-responsive no-padding">
										...
										<div id="alerta"
											...
											<a href="#" class="close" data-dismiss="alert"
												aria-label="close">&times;</a> Cliente Excluído com Sucesso!
										</div>
										<table class="table table-hover">
											...
											<c:forEach var="c" items="${listaDeClientes}">
												<tr id="cliente${c.id}">
													<td><c:out value="${c.nome}"></c:out></td>
													<td><c:out value="${c.endereco}"></c:out></td>
													<td><c:out value="${c.contato}"></c:out></td>
													<td><a
														href="<c:url value="/atualizarcliente?clienteId=${c.id}"/>"><i
															class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
													<td><a href="#"
														onclick="return removeCliente(${c.id})"><i
